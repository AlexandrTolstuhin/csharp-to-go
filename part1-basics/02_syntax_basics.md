...
- [3. Коллекции](#массивы)
  - [Массивы](#массивы)
  - [Слайсы](#слайсы-slices--динамические-массивы)
  - [Мапы](#мапы-maps--словари)
  ...
  - [strings.Lines и strings.SplitSeq (Go 1.24)](#stringslines-и-stringssplitseq-go-124)
- [4. Управляющие конструкции](#3-управляющие-конструкции)
  - [Range over integers (Go 1.22)](#range-over-integers-go-122)
- [5. Функции и defer](#4-функции)

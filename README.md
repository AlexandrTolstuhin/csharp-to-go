...
Этот курс — живой документ, и ваш вклад приветствуется!

### Как помочь:

1. **Нашли ошибку?** → [Создайте Issue](https://github.com/AlexandrTolstuhin/csharp-to-go/issues/new)
2. **Хотите дополнить материал?** → Сделайте Fork и Pull Request
3. **Есть идея для улучшения?** → Предложите в [Discussions](https://github.com/AlexandrTolstuhin/csharp-to-go/discussions)

### Что можно улучшить:

- ✍️ Исправление опечаток и улучшение текста
...
- Придерживайтесь стиля существующих материалов
- Добавляйте примеры с сравнением C# ↔ Go
- Тестируйте код перед коммитом
- Описывайте изменения в commit message
...
Вы можете свободно использовать, изменять и распространять эти материалы с указанием авторства.
...
👉 [QUICKSTART.md](./QUICKSTART.md) — установка Go и первый проект за 10 минут

### Полноценное обучение
**Готовы к систематическому изучению?**

📖 [Часть 1: Установка и настройка окружения](./part1-basics/01_setup_environment.md)

### Навигация по материалам
- 📋 [LEARNING_PLAN.md](./LEARNING_PLAN.md) — детальный план обучения
- 📂 [STRUCTURE.md](./STRUCTURE.md) — визуализация структуры курса
...
**Alexandr Tolstukhin**
- GitHub: [@AlexandrTolstuhin](https://github.com/AlexandrTolstuhin)
- Репозиторий: [csharp-to-go](https://github.com/AlexandrTolstuhin/csharp-to-go)

Создано с помощью Claude Code для помощи Senior C# разработчикам в переходе на Go.

---

## ⭐ Поддержите проект

Если этот курс вам помог, поставьте ⭐ на GitHub!

[![GitHub stars](https://img.shields.io/github/stars/AlexandrTolstuhin/csharp-to-go?style=social)](https://github.com/AlexandrTolstuhin/csharp-to-go/stargazers)

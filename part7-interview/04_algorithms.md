...
- [Введение: специфика российских компаний](#введение-специфика-российских-компаний)
- [Задача 1: LRU Cache](#задача-1-lru-cache)
- [Задача 2: Two Sum](#задача-2-two-sum)
- [Задача 3: Валидация скобок](#задача-3-валидация-скобок)
- [Задача 4: Анаграммы](#задача-4-анаграммы)
- [Задача 5: Бинарный поиск](#задача-5-бинарный-поиск)
- [Задача 6: Merge Sorted Arrays](#задача-6-merge-sorted-arrays)
- [Задача 7: Top K элементов](#задача-7-top-k-элементов)
- [Задача 8: Реализация стека и очереди](#задача-8-реализация-стека-и-очереди)

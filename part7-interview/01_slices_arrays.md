...
- [Задача 1: Reverse slice](#задача-1-reverse-slice)
- [Задача 2: Удаление дубликатов](#задача-2-удаление-дубликатов)
- [Задача 3: Rotate slice](#задача-3-rotate-slice)
- [Задача 4: Пересечение двух слайсов](#задача-4-пересечение-двух-слайсов)
- [Задача 5: Flatten вложенных слайсов](#задача-5-flatten-вложенных-слайсов)
- [Задача 6: Chunk — разбивка на части](#задача-6-chunk--разбивка-на-части)
- [Задача 7: Что выведет код — gotchas](#задача-7-что-выведет-код--gotchas)
- [Задача 8: Фильтрация без аллокаций](#задача-8-фильтрация-без-аллокаций)

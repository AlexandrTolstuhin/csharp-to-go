...
### 1. [Задачи на слайсы и массивы](./01_slices_arrays.md)
...
### 2. [Задачи на горутины и каналы](./02_goroutines_channels.md)
...
### 3. [Задачи на map и синхронизацию](./03_maps_sync.md)
...
### 4. [Алгоритмические задачи](./04_algorithms.md)
...
### 5. [Системный дизайн на Go](./05_system_design.md)

...
- [HTTP в Go: веб-серверы](part3-web-api/01_http_server.md)
- [Структура проекта](part3-web-api/02_project_structure.md)
...
- [Проект 1: URL Shortener](part5-project1-url-shortener/README.md)
  - [Доменная модель](part5-project1-url-shortener/01_domain.md)
  - [Хранилище](part5-project1-url-shortener/02_storage.md)
  - [HTTP слой](part5-project1-url-shortener/03_http.md)
  - [Тестирование](part5-project1-url-shortener/04_testing.md)
  - [Деплой](part5-project1-url-shortener/05_deployment.md)
- [Проект 2: E-Commerce Platform](part5-project2-ecommerce/README.md)
  - [Доменная модель](part5-project2-ecommerce/01_domain.md)
  - [User Service](part5-project2-ecommerce/02_user_service.md)
  - [Catalog Service](part5-project2-ecommerce/03_catalog_service.md)
  - [Order Service](part5-project2-ecommerce/04_order_service.md)

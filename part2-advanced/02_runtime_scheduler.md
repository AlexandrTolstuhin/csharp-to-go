...
- [ ] Архитектуру GMP (Goroutine, Machine, Processor)
- [ ] Как работает work-stealing алгоритм
- [ ] Разницу между cooperative и preemptive планированием
- [ ] Влияние GOMAXPROCS на производительность
- [ ] Отличия от .NET ThreadPool
- [ ] Как использовать go tool trace для диагностики
- [ ] Как оптимизировать код под планировщик
- [ ] Когда создавать worker pool вместо миллионов горутин

...
## Содержание
- [Введение](#введение)
- [Архитектура GMP](#архитектура-gmp)
- [Work-Stealing алгоритм](#work-stealing-алгоритм)
- [Preemption (вытеснение)](#preemption-вытеснение)
- [GOMAXPROCS](#gomaxprocs)
- [Сравнение с .NET ThreadPool](#сравнение-с-net-threadpool)
- [Трассировка и диагностика](#трассировка-и-диагностика)
- [Оптимизация под планировщик](#оптимизация-под-планировщик)

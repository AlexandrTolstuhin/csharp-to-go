...
### 1. [Проект 1: URL Shortener](./project1-url-shortener/)
...
### 2. [Проект 2: E-commerce Platform](./project2-ecommerce/)
...
- [4. Order Service (Saga Pattern)](./project2-ecommerce/04_order_service.md)
- [5. Payment Service и Notification Service](./project2-ecommerce/05_payment_notification.md)
